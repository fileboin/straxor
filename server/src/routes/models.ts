...
const OPENCODE_ZEN_MODELS: CatalogModel[] = [
  ...
  { id: "opencode/deepseek-v3.2-free", name: "DeepSeek V3.2 Free", free: true },
  { id: "opencode/deepseek-r1-free", name: "DeepSeek R1 Free", free: true, thinking: true },
  ...
  { id: "opencode/qwen3-coder-free", name: "Qwen3 Coder Free", free: true },
  { id: "opencode/glm-5.2-free", name: "GLM 5.2 Free", free: true, thinking: true },
  // Coding-first models
  { id: "opencode/gpt-5.3-codex", name: "GPT-5.3 Codex", thinking: true },
  { id: "opencode/gpt-5.2-codex", name: "GPT-5.2 Codex", thinking: true },
  { id: "opencode/gpt-5.1-codex", name: "GPT-5.1 Codex", thinking: true },
  { id: "opencode/gpt-5-codex", name: "GPT-5 Codex", thinking: true },
  ...
  { id: "opencode/claude-opus-4-8", name: "Claude Opus 4.8", thinking: true },
  { id: "opencode/claude-sonnet-5", name: "Claude Sonnet 5", thinking: true },
  { id: "opencode/claude-haiku-4-5", name: "Claude Haiku 4.5", thinking: true },
  { id: "opencode/deepseek-v4-pro", name: "DeepSeek V4 Pro", thinking: true },
  { id: "opencode/deepseek-v4-flash", name: "DeepSeek V4 Flash", thinking: true },
  { id: "opencode/deepseek-v3.2", name: "DeepSeek V3.2", thinking: true },
  { id: "opencode/deepseek-r1", name: "DeepSeek R1", thinking: true },
  { id: "opencode/gpt-5.5", name: "GPT-5.5", thinking: true },
  { id: "opencode/gpt-5.4", name: "GPT-5.4", thinking: true },
  { id: "opencode/gpt-5", name: "GPT-5", thinking: true },
  { id: "opencode/gpt-4.1", name: "GPT-4.1" },
  { id: "opencode/gemini-3.1-pro", name: "Gemini 3.1 Pro", thinking: true },
  { id: "opencode/gemini-3.1-flash", name: "Gemini 3.1 Flash", thinking: true },
  { id: "opencode/qwen3-coder-480b", name: "Qwen3 Coder 480B", thinking: true },
  { id: "opencode/qwen3-coder-235b", name: "Qwen3 Coder 235B", thinking: true },
  { id: "opencode/glm-5.2", name: "GLM 5.2", thinking: true },
  { id: "opencode/kimi-k2.5", name: "Kimi K2.5", thinking: true },
  { id: "opencode/mim2-480b", name: "MIM2 480B", thinking: true },
  { id: "opencode/yi-lightning-2.0", name: "Yi Lightning 2.0" },
];
...
const OPENCODE_GO_MODELS: CatalogModel[] = [
  ...
  { id: "opencode_go/minimax-m2.5", name: "MiniMax M2.5", thinking: true },
  { id: "opencode_go/gpt-5.5", name: "GPT-5.5", thinking: true },
  { id: "opencode_go/gpt-5.4", name: "GPT-5.4", thinking: true },
  { id: "opencode_go/gpt-5.3-codex", name: "GPT-5.3 Codex", thinking: true },
  { id: "opencode_go/gpt-5.2-codex", name: "GPT-5.2 Codex", thinking: true },
  { id: "opencode_go/gpt-5-codex", name: "GPT-5 Codex", thinking: true },
  { id: "opencode_go/deepseek-v4-pro", name: "DeepSeek V4 Pro", thinking: true },
  { id: "opencode_go/deepseek-v4-flash", name: "DeepSeek V4 Flash", thinking: true },
  { id: "opencode_go/deepseek-v3.2", name: "DeepSeek V3.2", thinking: true },
  { id: "opencode_go/deepseek-r1", name: "DeepSeek R1", thinking: true },
  { id: "opencode_go/claude-sonnet-4-6", name: "Claude Sonnet 4.6", thinking: true },
  { id: "opencode_go/claude-sonnet-5", name: "Claude Sonnet 5", thinking: true },
  { id: "opencode_go/claude-opus-4-6", name: "Claude Opus 4.6", thinking: true },
  { id: "opencode_go/claude-opus-4-8", name: "Claude Opus 4.8", thinking: true },
  { id: "opencode_go/claude-haiku-4-5", name: "Claude Haiku 4.5", thinking: true },
  { id: "opencode_go/gemini-3.1-pro", name: "Gemini 3.1 Pro", thinking: true },
  { id: "opencode_go/gemini-3.1-flash", name: "Gemini 3.1 Flash", thinking: true },
  { id: "opencode_go/grok-4", name: "Grok 4", thinking: true },
  { id: "opencode_go/qwen3-coder-480b", name: "Qwen3 Coder 480B", thinking: true },
  { id: "opencode_go/glm-5.2", name: "GLM 5.2", thinking: true },
  { id: "opencode_go/kimi-k2.5", name: "Kimi K2.5", thinking: true },
  { id: "opencode_go/mim2-480b", name: "MIM2 480B", thinking: true },
  { id: "opencode_go/llama-4-maverick", name: "Llama 4 Maverick" },
];
