...
export function registerAll(register: (adapter: ConnectionAdapter) => void): void {
  ...
  register(makeAIAdapter("anthropic", "Anthropic", "Anthropic API — Claude Sonnet 4.6, Opus 4.6, Haiku 4.5", "🧠", "https://api.anthropic.com", { key: "model", label: "Model", type: "select", required: false, defaultValue: "claude-sonnet-4-6", options: [{ label: "Claude Sonnet 4.6", value: "claude-sonnet-4-6" }, { label: "Claude Opus 4.6", value: "claude-opus-4-6" }, { label: "Claude Haiku 4.5", value: "claude-haiku-4-5" }] }));
  ...
  register(makeAIAdapter("together", "Together AI", "Open-source models (Llama, Qwen, DeepSeek) hosted in the cloud", "🤝", "https://api.together.xyz", { key: "model", label: "Model", type: "select", required: false, defaultValue: "meta-llama/Llama-3.3-70B-Instruct-Turbo", options: [{ label: "Llama 3.3 70B Instruct", value: "meta-llama/Llama-3.3-70B-Instruct-Turbo" }, { label: "Llama 3.1 405B Instruct", value: "meta-llama/Llama-3.1-405B-Instruct-Turbo" }, { label: "Qwen2.5 72B Instruct", value: "Qwen/Qwen2.5-72B-Instruct-Turbo" }, { label: "DeepSeek V3", value: "deepseek-ai/DeepSeek-V3" }, { label: "DeepSeek R1", value: "deepseek-ai/DeepSeek-R1" }] }));
}
